...
<body>
   <form id="form1" runat="server">
     ...
     <div id="header">
        <div class="container">
            <nav>
                </a><asp:Image ID="Image29" runat="server" ImageUrl="~/images/AnidexLogo.png" />
                <ul id="navbar">
                    <li><a href="#home">TRENDING<span></span></a></li>
                    <li><a href="#ath_container">ALL TIME HITS<span></span></a></li>
                    <li><a href="#recommendations">RECOMMENDATIONS<span></span></a></li>
                    <li>
                        <a><asp:Button ID="Button1" runat="server" BackColor="Transparent" BorderStyle="None" ForeColor="Gold" Height="25px" Font-Size="20px" OnClick="Button1_Click1" Text="LOGOUT" Width="95px" /><span></span></a>
                    </li>
                    <li><asp:Label ID="Label1" CssClass="welcome" runat="server" Text="WELCOME"></asp:Label></li>
                </ul>
            </nav>
        </div>
    </div>  
   ...
   <div id="home">
    ...
    <div id="recommendations">
        ...
        <p class="options">
            <asp:TextBox ID="TextBox2" class="buttons" runat="server" OnTextChanged="TextBox2_TextChanged" placeholder="Search" autocomplete="off" Height="40px" Width="200px" AutoPostBack="true" ForeColor="White"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" class="buttons" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Height="40px" Width="180px" AutoPostBack="true" >
                ...
                <asp:ListItem Value="Isekai">Isekai</asp:ListItem>
            </asp:DropDownList>
            <asp:DropDownList ID="DropDownList2" class="buttons" runat="server" OnSelectedIndexChanged="DropDownList2_SelectedIndexChanged" Height="40px" Width="180px" AutoPostBack="true">
